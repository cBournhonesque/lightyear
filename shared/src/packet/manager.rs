...
pub(crate) struct PacketManager<P: Protocol> {
...
impl<P: Protocol> PacketManager<P> {
    pub fn new(channel_registry: &'static ChannelRegistry<P>) -> Self {
        Self {
    ...
    pub(crate) fn build_new_packet(&mut self) -> Packet<P> {
