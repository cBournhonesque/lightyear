...
- Keep stopped P2P sessions out of input processing and prediction, even when joined links remain.
  Joining sessions still process inputs and prediction for catch-up before gameplay activation.
