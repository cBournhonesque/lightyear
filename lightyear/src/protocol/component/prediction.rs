...
use crate::prelude::{ComponentRegistry, Linear};
...
impl ComponentRegistry {
        pub fn predicted_component_ids(
            &self,
        ...
        pub fn set_prediction_mode<C: SyncComponent>(&mut self, history_component_id: Option<ComponentId>, mode: ComponentSyncMode) {
            let kind = ComponentKind::of::<C>();
            self.prediction_map
                .entry(kind)
                .or_insert_with(|| PredictionMetadata::default_from::<C>(history_component_id, mode));
        }
        ...
        pub fn set_correction<C: SyncComponent + PartialEq>(
            &mut self,
