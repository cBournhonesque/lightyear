...
// use crate::protocol::message::{register_message, MessageError, MessageKind, MessageRegistration, MessageType, Metadata, ReceiveMessageFn, ReceiveMessageMetadata};
...
// ) {
//     register_message::<E>(app, direction, MessageType::Event)
// }
//
