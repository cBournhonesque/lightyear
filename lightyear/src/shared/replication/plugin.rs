...
pub(crate) mod shared {
    ...
    use crate::prelude::{DisableReplicateHierarchy, NetworkRelevanceMode, PrePredicted, RemoteEntityMap, Replicated, ReplicationConfig, ReplicationGroup, ShouldBePredicted, TargetEntity};
