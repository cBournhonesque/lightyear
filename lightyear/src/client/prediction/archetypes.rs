...
pub(crate) struct PredictedArchetypes {
    ...
    /// Cached archetypes
    pub(crate) archetypes: Vec<PredictedArchetype>,
}

/// An archetype that has some predicted components
pub(crate) struct PredictedArchetype {
    pub(crate) id: ArchetypeId,
    pub(crate) components: Vec<PredictedComponent>,
}
...
impl PredictedArchetypes {
    ...
    pub(crate) fn update(&mut self, world: &World, registry: &ComponentRegistry) {
        ...
        {
            let mut predicted_archetype = PredictedArchetype {
                id: archetype.id(),
                components: Vec::new(),
            };
